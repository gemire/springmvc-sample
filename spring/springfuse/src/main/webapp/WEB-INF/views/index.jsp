...
<body>
	<div class="span-24 last">
		<h2>
			...
			<security:authorize ifAllGranted="ROLE_USER">${accountContext.account.username}</security:authorize>
		</h2>
		<p>
		...
		<security:authorize ifAllGranted="ROLE_ADMIN">
			...
			<ul class="inline">
				...
				<li><a href="${pageContext.request.contextPath}/domain/contactinfo/search">contactInfo</a></li>
