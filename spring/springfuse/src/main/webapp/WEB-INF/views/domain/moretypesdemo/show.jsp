...
<body>
	...
	<a href="${pageContext.request.contextPath}/domain/moretypesdemo/update/${moreTypesDemo.primaryKey}" class="ajaxy button button-edit"><fmt:message key="crud.edit.button" /></a>
