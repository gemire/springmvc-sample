...
<body>
	...
	<a href="${pageContext.request.contextPath}/domain/account/show/${account.primaryKey}" class="ajaxy button button-show"><fmt:message key="crud.show.button" /></a>
	...
	<form:form action="${pageContext.request.contextPath}/domain/account/update/${account.primaryKey}" modelAttribute="account" method="POST">
