...
<body>
	...
	<a href="${pageContext.request.contextPath}/domain/document/show/${document.primaryKey}" class="ajaxy button button-show"><fmt:message key="crud.show.button" /></a>
	...
	<form:form action="${pageContext.request.contextPath}/domain/document/update/${document.primaryKey}" modelAttribute="document" enctype="multipart/form-data" method="POST">
