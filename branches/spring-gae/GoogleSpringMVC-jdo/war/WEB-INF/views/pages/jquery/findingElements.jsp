...
<button onclick="findDiv()">Find the div</button><br/>
<button onclick="findDivWithGrey()">Find the grey box in the div</button><br/>
<button onclick="findDivWithBlue()">Find the paragraphs in the blue box</button><br/>
<button onclick="findDivWithBlueExt2()">Find the paragraphs in the blue box External</button><br/>
