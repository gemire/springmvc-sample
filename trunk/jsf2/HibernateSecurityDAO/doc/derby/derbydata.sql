-- in order for derby data
INSERT INTO security.applications (id, application_name) VALUES
(55, 'AcceptableBO'),
(23, 'APEXMenu'),
...
INSERT INTO security.groups (id, group_name) VALUES
(8, 'BrandEdit'),
(6, 'BrandUsers'),
(9, 'ExclusionsUsers'),
(5, 'HeroColor'),
...
INSERT INTO security.users (UserID, username) VALUES
('alb', 'April Jones'),
('ale', 'Angie Smith'),
('alm', 'Andrea Thompson'),
('ayb', 'Alissa Alpha'),
...
INSERT INTO security.application_groups (id, application_id, group_id) VALUES
(130, 26, 1),
(131, 27, 1),
(132, 28, 1),
(133, 29, 1),
...
INSERT INTO security.group_assignments (id, user_id, group_id) VALUES
(2, 'ale', 1),
(3, 'ayb', 1),
(4, 'blz', 1),
(5, 'cad', 1),
