...
<body>
	...
	<a href="${pageContext.request.contextPath}/domain/book/show/${book.primaryKey}" class="ajaxy button button-show"><fmt:message key="crud.show.button" /></a>
	...
	<form:form action="${pageContext.request.contextPath}/domain/book/update/${book.primaryKey}" modelAttribute="book" method="POST">
