...
public class WebServiceFileInputReaderImpl implements WebServiceFileInputReader {
    ...
    private static Logger log = LoggerFactory.getLogger(WebServiceFileInputReaderImpl.class);

    @Override
    public ArrayList<RegisterInput> processInput(InputStream input) {
        ArrayList<RegisterInput> inputList = new ArrayList<RegisterInput>();
        ...
        try {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                inputList.add(nextTransmission);
            }
        } catch (Exception err) {
