...
public final class SaajUtils {
	...
	private static final String MULE_SAAJ_HEADER_URI = "http://www.mulesource.org/schema/mule/saaj/2.2";
	private static final String MULE_SAAJ_HEADER_PREFIX = "mule-saaj";
	 ...
	 */
	public static SOAPMessage buildSOAPMessage(InputStream input, Map<String, String> headers, MessageFactory messageFactory) {
		SOAPMessage soapMessage;
		try {
