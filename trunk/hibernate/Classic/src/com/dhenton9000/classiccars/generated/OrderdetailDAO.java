 ...
 * 
 * @see com.dhenton9000.classiccars.generated.Orderdetail
...
public class OrderdetailDAO extends HibernateDaoSupport {
	...
	public Orderdetail findById(
			com.dhenton9000.classiccars.generated.OrderdetailId id) {
		log.debug("getting Orderdetail instance with id: " + id);
		try {
			Orderdetail instance = (Orderdetail) getHibernateTemplate().get(
					"com.dhenton9000.classiccars.generated.Orderdetail", id);
			return instance;
		} catch (RuntimeException re) {
