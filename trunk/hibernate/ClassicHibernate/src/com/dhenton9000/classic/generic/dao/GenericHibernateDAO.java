...
import com.dhenton9000.classic.Utils;
...
public class GenericHibernateDAO {
	...
	public GenericHibernateDAO() {
		try {
			...
			log.error("ClassicCarsDAO DAO start problem "
					+ Utils.createErrorMessage(ex));
		}
	}
	

	public Object findById(java.lang.Integer id, Class clazz)
	...
	public void attachDirty(Object detachedInstance)
		...
		log.debug("attaching dirty for " + detachedInstance.getClass().getName());
		Session session = null;
		Transaction tx = null;
		try {
			session = HibernateFactory.openSession();
	...
	public void attachClean(Object detachedInstance)
		...
		log.debug("attaching clean for " + detachedInstance.getClass().getName());
		Session session = null;
		Transaction tx = null;
		try {
			session = HibernateFactory.openSession();
