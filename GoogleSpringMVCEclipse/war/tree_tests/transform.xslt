    ...
    <xsl:template match="level1">
        ...
        <li>
            ...
            <input class="checkbox large"  type="checkbox">
                ...
                <xsl:attribute name="onclick">
                    <xsl:value-of select="concat('XTree.selectItem(1,', @id,');')" />
                </xsl:attribute>
            </input>   
        ...
        <ul> 
            ...
            <li>
                ...
                <input class="checkbox large"  type="checkbox">
                    ...
                    <xsl:attribute name="onclick">
                        <xsl:value-of select="concat('XTree.selectItem(2,',@id,');')" />
                    </xsl:attribute>
                </input>   
    ...
    <xsl:template match="level3">
        <ul>
            ...
            <li>
                ...
                <xsl:attribute name="class">
                    <xsl:choose>
                        <xsl:when test="@visible = 'yes'">tree-leaf</xsl:when>
                        <xsl:otherwise>tree-hidden</xsl:otherwise>
                    </xsl:choose>  
                </xsl:attribute>
                -->
                <xsl:variable name="escapedName">
