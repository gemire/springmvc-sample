 ...
 * 
 * @see com.dhenton9000.classiccars.generated.Payment
...
public class PaymentDAO extends HibernateDaoSupport {
	...
	public Payment findById(com.dhenton9000.classiccars.generated.PaymentId id) {
		log.debug("getting Payment instance with id: " + id);
		try {
			Payment instance = (Payment) getHibernateTemplate().get(
					"com.dhenton9000.classiccars.generated.Payment", id);
			return instance;
		} catch (RuntimeException re) {
