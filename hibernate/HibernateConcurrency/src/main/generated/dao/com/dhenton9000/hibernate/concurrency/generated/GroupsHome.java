 ...
 * @see com.dhenton9000.hibernate.concurrency.generated.Groups
    ...
    public Groups findById( java.lang.Integer id) {
        ...
        try {
            Groups instance = (Groups) sessionFactory.getCurrentSession()
                    .get("com.dhenton9000.hibernate.concurrency.generated.Groups", id);
            if (instance==null) {
    ...
    public List findByExample(Groups instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.dhenton9000.hibernate.concurrency.generated.Groups")
