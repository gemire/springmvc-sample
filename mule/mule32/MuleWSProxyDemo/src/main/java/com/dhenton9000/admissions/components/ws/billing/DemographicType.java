 ...
 *         &lt;element name="gender" type="{http://www.mule-health.com/SOA/model/1.0}genderType"/>
...
@XmlType(name = "demographicType", namespace = "http://www.mule-health.com/SOA/model/1.0", propOrder = {
    "nationalId",
    "firstName",
    "lastName",
    "address1",
