 ...
 * @author dhenton
 */
public class SimpleMuleLauncher {

    private static final Logger log = LogManager.getLogger(SimpleMuleLauncher.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            mm = new DefaultMuleMessage("get a job, commit", context);
            //localClient.dispatch("jms://input", mm);
            mm = new DefaultMuleMessage("get a job, general", context);
            //localClient.dispatch("jms://input", mm);
            mm = new DefaultMuleMessage("get a job, rollback", context);
            localClient.dispatch("jms://input", mm);
